...
extern NSString *META_SHOW_PUBLISHED_DATE_KEY;
...
@class SapphireMetaDataUpgrading,_SapphireFileMetaData;
@interface _SapphireFileMetaData
@end
...
- (NSDictionary *)getDisplayedMetaDataInOrder:(NSArray * *)array;
- (unsigned int)resumeTimeValue;
/*!
