...
{
    NSLog(@"hiding");
	NSString *fullPath=[FRAP_PATH stringByAppendingPathComponent:[path stringByAppendingPathComponent:@"/Contents/Info.plist"]];
...
- (int)plistShowFrap:(NSString *)path
{
    ...
    if (final==-0.0000000000002665f)
        ...
        final=final*-1.;
	[infoplist setValue:[NSNumber numberWithFloat:final] forKey:@"FRAppliancePreferedOrderValue"];
    NSLog(@"infoPlist: %@",infoplist);
    [self writeToLog:[NSString stringWithFormat:@"%@",infoplist,nil]];
    [[NSFileManager defaultManager] removeFileAtPath:fullPath handler:nil];
    NSLog(@"infoPlist: %@",infoplist);
    [self writeToLog:[NSString stringWithFormat:@"%@",infoplist,nil]];
	[infoplist writeToFile:fullPath atomically:YES];
