...
////            [c _startSlideshow];
            ...
            collection = [SMImageReturns photoCollectionForPath:[SMMPrefs screensaverFolder]];
        }
    ...
    else 
    {
        ...
        if ([SMPreferences screensaverUseAppleProvider]) {
            ...
            //NSLog(@"use Old");
            proxies = [SMImageReturns imageProxiesForPath:[SMMPrefs screensaverFolder]];
        }
...
-(id)init
{
    ...
    NSArray *assets=[SMImageReturns mediaAssetsForPath:[SMMPrefs screensaverFolder]];
