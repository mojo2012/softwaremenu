...

{
	...
	[self setTitle: [_theInformation valueForKey:@"name"]];
	[self setSourceImage: [_theInformation valueForKey:@"name"]];
	
	[self setSourceText: [_theInformation valueForKey:@"name"]];   // this lays itself out
	[self appendSourceText: [_theInformation valueForKey:@"downloadtext"]];
...
- (void) dealloc
{
	...
	[_downloadTitle release];
	[_downloadText release];
...
/*-(void) processdownload
{
	...
	if([man fileExistsAtPath:[@"/System/Library/Finder/Contents/Plugins/" stringByAppendingPathComponent:[thename stringByAppendingPathExtension:@"frappliance"]]])
	{
