...
//{ 
//    NSLog(@"object: %@",[_items objectAtIndex:row]);
//    id a = [_items objectAtIndex:row];
//    if ([[[_options objectAtIndex:row]objectAtIndex:0] isEqualToString:@"osupdate"]) {
//        NSFileManager *man = [NSFileManager defaultManager];
//        if(![man fileExistsAtPath:@"/Users/frontrow/Updates/final.dmg"])
//            [a setDimmed:TRUE];
//        else 
...
-(void)itemSelected:(long)fp8
{
	...
	if([[[_options objectAtIndex:fp8]objectAtIndex:0] isEqualToString:@"osupdate"] && ![[self itemForRow:fp8] dimmed])
	{
...
-(void)downloadthemalready;
{
    ...
    [newController2 setForceDestination:TRUE];
...
-(void)moveFiles
{
	...
	for( counter=0; counter < i ; counter++)
	{
		...
		NSLog(@"0");
		if([[obje lastPathComponent] isEqualToString:@"Perian_1.1.4.dmg"])
		{
			[man movePath:[atvpath stringByAppendingPathComponent:@"Perian_1.1.4.dmg"] toPath:[[atvpath stringByDeletingLastPathComponent] stringByAppendingPathComponent:@"Perian_1.1.4.dmg"] handler:nil];
		}
